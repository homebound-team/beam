...
class CssBuilder<T extends Properties> {
  ...
  get ifMd() {
    return this.newCss({ selector: "@media (min-width: 600px) and (max-width: 1024px)" });
  }
  get ifSmOrMd() {
    return this.newCss({ selector: "@media (max-width: 1024px)" });
  }
  get ifMdAndUp() {
  ...
  get ifLg() {
    return this.newCss({ selector: "@media (min-width: 1025px)" });
  }
  get ifMdOrLg() {
    return this.newCss({ selector: "@media (min-width: 600px)" });
  }
...
export enum Breakpoints {
  ...
  md = "@media (min-width: 600px) and (max-width: 1024px)",
  smOrMd = "@media (max-width: 1024px)",
  mdAndUp = "@media (min-width: 600px)",
  mdAndDown = "@media (max-width: 1024px)",
