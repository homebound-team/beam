...
export const smOrMd = "@media screen and (max-width:1024px)" as Breakpoint;
export const mdAndUp = "@media screen and (min-width:600px)" as Breakpoint;
export const mdAndDown = "@media screen and (max-width:1024px)" as Breakpoint;
export const lg = "@media screen and (min-width:1025px)" as Breakpoint;
