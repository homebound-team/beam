...
export enum Palette {
  Black = "rgba(17,24,39,1)",White = "rgba(254,254,254,1)",CoolGray50 = "rgba(249,250,251,1)",CoolGray100 = "rgba(243,244,246,1)",CoolGray200 = "rgba(229,231,235,1)",CoolGray300 = "rgba(209,213,219,1)",CoolGray400 = "rgba(156,163,175,1)",CoolGray500 = "rgba(107,114,128,1)",CoolGray600 = "rgba(75,85,99,1)",CoolGray700 = "rgba(55,65,81,1)",CoolGray800 = "rgba(31,41,55,1)",CoolGray900 = "rgba(17,24,39,1)",Coral50 = "rgba(255,234,227,1)",Coral100 = "rgba(255,223,212,1)",Coral200 = "rgba(255,194,174,1)",Coral300 = "rgba(255,165,136,1)",Coral400 = "rgba(255,123,82,1)",Coral500 = "rgba(255,87,34,1)",Coral600 = "rgba(222,53,11,1)",Coral700 = "rgba(182,58,19,1)",Coral800 = "rgba(143,45,14,1)",Coral900 = "rgba(115,40,16,1)",Amber50 = "rgba(255,251,235,1)",Amber100 = "rgba(254,243,199,1)",Amber200 = "rgba(253,230,138,1)",Amber300 = "rgba(252,211,77,1)",Amber400 = "rgba(251,191,36,1)",Amber500 = "rgba(245,158,11,1)",Amber600 = "rgba(217,119,6,1)",Amber700 = "rgba(180,83,9,1)",Amber800 = "rgba(146,64,14,1)",Amber900 = "rgba(120,53,15,1)",Emerald50 = "rgba(236,253,245,1)",Emerald100 = "rgba(209,250,229,1)",Emerald200 = "rgba(167,243,208,1)",Emerald300 = "rgba(110,231,183,1)",Emerald400 = "rgba(52,211,153,1)",Emerald500 = "rgba(16,185,129,1)",Emerald600 = "rgba(5,150,105,1)",Emerald700 = "rgba(4,120,87,1)",Emerald800 = "rgba(6,95,70,1)",Emerald900 = "rgba(6,78,59,1)",Sky50 = "rgba(239,244,255,1)",Sky100 = "rgba(219,227,254,1)",Sky200 = "rgba(191,209,254,1)",Sky300 = "rgba(147,170,253,1)",Sky400 = "rgba(109,131,246,1)",Sky500 = "rgba(71,101,255,1)",Sky600 = "rgba(37,45,235,1)",Sky700 = "rgba(29,48,216,1)",Sky800 = "rgba(30,53,175,1)",Sky900 = "rgba(30,41,138,1)",Violet50 = "rgba(245,243,255,1)",Violet100 = "rgba(237,233,254,1)",Violet200 = "rgba(221,214,254,1)",Violet300 = "rgba(196,181,253,1)",Violet400 = "rgba(167,139,250,1)",Violet500 = "rgba(139,92,246,1)",Violet600 = "rgba(124,58,237,1)",Violet700 = "rgba(109,40,217,1)",Violet800 = "rgba(91,33,182,1)",Violet900 = "rgba(76,29,149,1)",Cool50 = "rgba(239,246,247,1)",Cool100 = "rgba(216,235,238,1)",Cool200 = "rgba(177,219,225,1)",Cool300 = "rgba(128,200,214,1)",Cool400 = "rgba(124,170,211,1)",Cool500 = "rgba(116,139,218,1)",Cool600 = "rgba(115,103,241,1)",Cool700 = "rgba(97,85,216,1)",Cool800 = "rgba(77,72,186,1)",Cool900 = "rgba(59,60,160,1)",Cool1000 = "rgba(42,47,135,1)",Cool1100 = "rgba(16,27,100,1)",
}
...
type Brand<K, T> = K & { __brand: T };type Breakpoint = Brand<string, 'Breakpoint'>;
