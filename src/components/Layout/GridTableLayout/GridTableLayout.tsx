...
import { DocumentScrollRightPaneLayout } from "../RightPaneLayout/DocumentScrollRightPaneLayout";
import { resolveWithRightPaneOptions } from "../RightPaneLayout/documentScrollRightPaneMode";
import { WithRightPane } from "../RightPaneLayout/types";
  ...
  const tableScrollContent = (
    <>
      ...
      {inDocumentScrollLayout ? (
        ...
        rightPane ? (
          <DocumentScrollRightPaneLayout paneWidth={rightPane.width} mode={rightPane.mode}>
            {tableBody}
