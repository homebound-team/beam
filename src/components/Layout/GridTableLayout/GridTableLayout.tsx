...
interface ViewToggleButtonProps {
  viewType: GridTableLayoutViewType;
  onViewTypeChange: (viewType: GridTableLayoutViewType) => void;
}

function ViewToggleButton({ viewType, onViewTypeChange, ...props }: ViewToggleButtonProps) {
  return (
    <ButtonGroup
      size="sm"
      buttons={[
