...
import { safeKeys } from "src/utils/helpers";
  ...
  return (props: GridStyleDef = {}) => {
    ...
    if (!cache[key]) {
      ...
      const groupedLevels = {
        0: {
          cellCss: {
            ...Css.xsSb.mhPx(56).color(Tokens.OnSurfaceMuted).bgColor(Tokens.SurfaceHover).boxShadow(insetSeparator).$,
      ...
      cache[key] = {
        ...
        totalsCellCss: Css.color(Tokens.OnSurfaceMuted).bgColor(Tokens.SurfaceHover).xsSb.hPx(totalsRowHeight).pPx(12)
          .$,
        ...
        cellCss: {
          ...
          ...(cellHighlight ? Css.onHover.bgColor(Tokens.SurfaceHover).$ : {}),
        },
        ...
        rowHoverColor: Tokens.SurfaceHover,
...
export const cardStyle: GridStyle = {
  ...
  nonHeaderRowCss: Css.br4.oh.ba
    ...
    .bshBasic.onHover.bshHover.bc(Tokens.OnSurfaceMuted).$,
