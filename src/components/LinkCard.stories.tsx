...
const title = "Review location changes: 1 added, 1 renumbered, 1 removed.";
const message = (
  <>
...
const longMessage = (
  <>
    According to the latest document upload <a href="/documents/1">Document Name Here</a> uploaded by Drew Whiting on
    July 15th 2026, here is a summary of changes to option configuration. Locations that moved between elevations keep
    their original numbering, so the take-off quantities you already approved are unaffected, but any option attached to
    a removed location needs to be reassigned before this plan can be released to the field. Three of the renumbered
    locations also appear in the structural package, which has not yet been re-uploaded, so those may change again.
  </>
);
