...
export function PresentationFieldProps() {
  return (
    <div>
      ...
      <div css={Css.pb2.mb2.bb.bcGray300.$}>
        <h1 css={Css.xl.$}>Hidden Labels</h1>
      ...
      <div css={Css.pb2.mb2.bb.bcGray300.$}>
        <h1 css={Css.xl.$}>Number Alignment Right</h1>
      ...
      <div css={Css.pb2.mb2.bb.bcGray300.$}>
        <h1 css={Css.xl.$}>Small Font size</h1>
      ...
      <div css={Css.pb2.mb2.bb.bcGray300.$}>
        <h1 css={Css.xl.$}>visuallyDisabled=false</h1>
