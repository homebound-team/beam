import { ContrastScope, LoadingSkeleton, type LoadingSkeletonProps } from "src/components";
...
export const Examples = () => (
  <div>
    <h1 css={Css.xl2.mb1.bb.bcGray400.$}>Sizes</h1>
    ...
    <h1 css={Css.xl2.mb1.mt4.bb.bcGray400.$}>Multiple Rows</h1>
    <LoadingSkeleton rows={3} />

    <h1 css={Css.xl2.mb1.mt4.bb.bcGray400.$}>Multiple Rows with Randomized Widths</h1>
    <LoadingSkeleton rows={6} randomizeWidths />

    <h1 css={Css.xl2.mb1.mt4.bb.bcGray400.$}>Rows and Columns</h1>
...
const Template = (args: LoadingSkeletonProps) => (
  <div>
    <h1 css={Css.xl2.mb1.bb.bcGray400.$}>Use Control Panel to Set Properties</h1>
