...
export function GridTableLayoutExample({
            ...
            rowStyles: {
              data: {
                onClick: (row: GridDataRow<GridTableLayoutRow>) =>
                  openRightPane({ content: <GridTableLayoutRightPaneDetail name={rowDetailName(row)} /> }),
              },
              parent: {
                onClick: (row: GridDataRow<GridTableLayoutRow>) =>
                  openRightPane({ content: <GridTableLayoutRightPaneDetail name={rowDetailName(row)} /> }),
  ...
  return (
    <GridTableLayout
      ...
      withRightPane={withRightPane ? 400 : undefined}
      tableProps={tableProps}
    />
  );
}

function rowDetailName(row: GridDataRow<GridTableLayoutRow>): string {
