...
| `WorkflowLayout`          | `WorkflowHeader`                | `workflowHeader: Omit<WorkflowHeaderProps, "stepperTabs">`; `steps: WorkflowLayoutStep[]`; `currentStep`; `onChange`; `fullWidthContent?` |
