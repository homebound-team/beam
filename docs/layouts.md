...
| `PageHeaderLayout`        | `PageHeader`                   | `pageHeader: PageHeaderProps` (`withAutoSave?` prepends `AutoSaveIndicator` in the header actions area; default false); body → **`children`**                                                                                                                                                                                                                                                                                                             |
