...
| `CenteredLayout`          | centered body-width shell      | `size: "sm" \| "lg"`; body → **`children`**. **Not** a chrome peer (see rule 2). `sm` = 720px content / 768px outer; `lg` = 1440px outer (1392px content at `md+`). Horizontal pad is 12px, 24px from `md` up. `FormSectionLayout` wraps `CenteredLayout size="sm"` — do not wrap it again. |
